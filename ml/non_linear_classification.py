...
def non_separable_train(df):
    print("Non Linear Classification Train API!!")
    ...
    specific = [left_Specific, down_Specific, right_Specific, up_Specific]
    gen = [left_Gen, down_Gen, right_Gen, up_Gen]
    opt = [left_Opt, down_Opt, right_Opt, up_Opt]
    return (specific, gen, opt)
